...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        self.undo_button = tk.Button(self, text="Undo", command=lambda: self.undo())
        ...
        self.undo_button.grid(row=3, column=0)
    ...
    def undo(self):
        ...
        self.originator.getStateFromMemento(self.caretaker.get(len(self.caretaker.mementoList) - 2))
        self.instructions_text.delete(1.0, tk.END)
        self.instructions_text.insert(tk.END, self.originator.getState())
