...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.move_output_to_input_button = tk.Button(self, text="Move Output to Input Code", command=lambda: app.code_text.insert("1.0", app.output_code_textbox.get("1.0", "end-1c")))
